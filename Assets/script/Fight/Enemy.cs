...
public class Enemy : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        defText = hpItemObj.transform.Find("").GetComponent<Text>();//找到组件中的防御力数值
        hpText = hpItemObj.transform.Find("").GetComponent<Text>();
        hpImg = hpItemObj.transform.Find("").GetComponent<Image>();//找到血条图标

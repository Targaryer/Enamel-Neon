...
public class CardItem : MonoBehaviour,IPointerEnterHandler,IPointerExitHandler,IBeginDragHandler,IDragHandler,IEndDragHandler
{
    ...
    private void Start()
    {
        ...
        transform.Find("卡牌模型").GetComponent<Image>().sprite = Resources.Load<Sprite>(data["BgIcon"]);
        transform.Find("卡牌模型/卡牌图标").GetComponent<Image>().sprite = Resources.Load<Sprite>(data["Icon"]);
